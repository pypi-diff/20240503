# Comparing `tmp/fazah-3.19.tar.gz` & `tmp/fazah-3.24.tar.gz`
...
## Comparing `fazah-3.19.tar` & `fazah-3.24.tar`
...
### Comparing `fazah-3.19/Fazah/fazah.py` & `fazah-3.24/Fazah/fazah.py`

 * *Files identical despite different names*

### Comparing `fazah-3.19/tests/test.openai.py` & `fazah-3.24/tests/test.openai.py`

 * *Files identical despite different names*

### Comparing `fazah-3.19/tests/test_gemini.py` & `fazah-3.24/tests/test_gemini.py`
