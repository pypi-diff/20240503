# Comparing `tmp/wgse_ng-0.0.4a1.tar.gz` & `tmp/wgse_ng-0.0.4a2.tar.gz`
...
## Comparing `wgse_ng-0.0.4a1.tar` & `wgse_ng-0.0.4a2.tar`
...
### Comparing `wgse_ng-0.0.4a1/PKG-INFO` & `wgse_ng-0.0.4a2/PKG-INFO`
...
### Comparing `wgse_ng-0.0.4a1/README.md` & `wgse_ng-0.0.4a2/README.md`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/WGSE_NG.egg-info/PKG-INFO` & `wgse_ng-0.0.4a2/WGSE_NG.egg-info/PKG-INFO`
...
### Comparing `wgse_ng-0.0.4a1/test/test_buckets.py` & `wgse_ng-0.0.4a2/test/test_buckets.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/test/test_fasta.py` & `wgse_ng-0.0.4a2/test/test_fasta.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/test/test_fasta_dictionary.py` & `wgse_ng-0.0.4a2/test/test_fasta_dictionary.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/test/test_sequence.py` & `wgse_ng-0.0.4a2/test/test_sequence.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/test/test_unknown_bases_stats.py` & `wgse_ng-0.0.4a2/test/test_unknown_bases_stats.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/wgse/configuration.py` & `wgse_ng-0.0.4a2/wgse/configuration.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/wgse/external.py` & `wgse_ng-0.0.4a2/wgse/external.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/wgse/genome_file_finder.py` & `wgse_ng-0.0.4a2/wgse/genome_file_finder.py`

 * *Files identical despite different names*

### Comparing `wgse_ng-0.0.4a1/wgse/variant_caller.py` & `wgse_ng-0.0.4a2/wgse/variant_caller.py`
