# Comparing `tmp/hbox-0.1.2.tar.gz` & `tmp/hbox-0.1.20.tar.gz`
...
## Comparing `hbox-0.1.2.tar` & `hbox-0.1.20.tar`
...
### Comparing `hbox-0.1.2/hbox/commands.py` & `hbox-0.1.20/hbox/commands.py`
...
### Comparing `hbox-0.1.2/hbox/config.py` & `hbox-0.1.20/hbox/config.py`

 * *Files identical despite different names*

### Comparing `hbox-0.1.2/PKG-INFO` & `hbox-0.1.20/README.md`
